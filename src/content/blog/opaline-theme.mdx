...
image: /blog/opaline-theme/logo.png
date: 2019-11-11
tags:
  - vscode
  - theme
...
import pythonImg from "./opaline-theme/python.png";
import rustImg from "./opaline-theme/rust.png";
import typescriptImg from "./opaline-theme/typescript.png";
...
<Image
  src={typescriptImg}
  quality="high"
  alt="TypeScript file with opaline theme syntax highlighting"
/>

<Image
  src={pythonImg}
  quality="high"
  alt="Python file with opaline theme syntax highlighting"
/>

<Image
  src={rustImg}
  quality="high"
  alt="Rust file with opaline theme syntax highlighting"
/>
